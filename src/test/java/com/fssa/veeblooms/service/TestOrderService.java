...
public class TestOrderService {
	...
	@Test
	public void testDeleteOrderedProductsByOrderId() throws CustomException, SQLException, DAOException {
		int orderIdToDelete = 43;
		OrderService.deleteOrderedProductsByOrderId(orderIdToDelete);
	}
